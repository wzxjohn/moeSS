...
<head>
    ...
    <script src="<?php echo base_url('static/js/AdminLTE/dashboard.js'); ?>" type="text/javascript"></script>

    <!-- AdminLTE for demo purposes -->
    <script src="<?php echo base_url('static/js/AdminLTE/demo.js'); ?>" type="text/javascript"></script>
